"""
    TRAINING SCRIPT FOR MODEL VERSION 0.5 WITH SPARSE METADATA ENCODER
    2025/11/20xw
"""
...
from IMC.helper import capture_console_to_log, log_training_start, log_training_end, setup_params_logging
...
experiment_name = "model_05_sparse_metadata_encoder"
...
if __name__ == "__main__":
    ...
    with capture_console_to_log(logger):
        num_samples = None
        train_loader = get_train_dataloader(batch_size=batch_size, num_samples=num_samples, num_workers=4)
        val_loader = get_valid_dataloader(batch_size=batch_size, num_samples=num_samples, num_workers=4)
        test_loader = get_test_dataloader(batch_size=batch_size, num_samples=num_samples, num_workers=4)
