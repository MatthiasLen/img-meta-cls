    ...
    def _get_backbone(self, backbone_name: str, pretrained: bool):
        ...
        if backbone_name.startswith("densenet"):
            ...
            if backbone_name == "efficientnet_b0":
                ...
                self.cnn = models.efficientnet_b1(
                    weights=models.EfficientNet_B1_Weights.DEFAULT if pretrained else None
                )
            elif backbone_name == "efficientnet_b2":
                self.cnn = models.efficientnet_b2(
            ...
            if not repo_dir:
                raise ValueError("DINOv3 backbones require IMC_DINOV3_REPO to point to a local dinov3 checkout.")
            ...
            if backbone_name == "dinov3_vits16":
                weights_path = (
                    os.path.join(weights_dir, "dinov3_vits16_pretrain_lvd1689m-08c60483.pth") if pretrained else None
                )
                ...
                weights_path = (
                    os.path.join(weights_dir, "dinov3_vitb16_pretrain_lvd1689m-73cec8be.pth") if pretrained else None
                )
                ...
                weights_path = (
                    os.path.join(weights_dir, "dinov3_vitl16_pretrain_lvd1689m-8aa4cbdd.pth") if pretrained else None
                )
